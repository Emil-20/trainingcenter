...
urlpatterns = [
 ...
 #**********************Training project ******************
    ...
    path('manager_accountant_attendance_table/', training_views.manager_accountant_attendance_table,name='manager_accountant_attendance_table'),

    path('manager_accountant_attendance/', training_views.manager_accountant_attendance,name='manager_accountant_attendance'),


    path('manager_accountant_leave/', training_views.manager_accountant_leave,name='manager_accountant_leave'),
    path('manager_accountant_leavelist/', training_views.manager_accountant_leavelist,name='manager_accountant_leavelist'),
    path('approvedstatus_accountant/<int:id>/', training_views.approvedstatus_accountant,name='approvedstatus_accountant'),
    path('Leave_rejected_accountant/<int:id>/', training_views.Leave_rejected_accountant,name='Leave_rejected_accountant'),
    path('manager_accountant_leavestatus/', training_views.manager_accountant_leavestatus,name='manager_accountant_leavestatus'),
    # ****************************Trainer******************************
    ...
    path('trainer_appliedleave/', training_views.trainer_appliedleave, name='trainer_appliedleave'),
...
# ****************************Admin******************************
   ...
   path('Admin_employee', training_views.Admin_employee, name='Admin_employee'),
    ...
    path('Admin_courselist/<int:id>/', training_views.Admin_courselist, name='Admin_courselist'),
     path('Admin_coursedetails/<int:id>/', training_views.Admin_coursedetails, name='Admin_coursedetails'),
